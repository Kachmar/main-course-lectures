...
namespace AsynchronouseProgramming
{
    ...
    /// The assigment is to create code that would output 123456789... to console
    /// Two thread should start in parallel calculating each part of the string 1234 and 56789...
    ...
    public class SumCalculator
    {
        public void Calculate(int from, int to, ManualResetEvent manualResetEvent)
        {
            ...
            TaskForStudents_ready.result += result;
        }
    }
}
